...
public class Vista_Pedidos extends JPanel {
	...
	public Vista_Pedidos() {
		...
		txtNombre.setBounds(368, 28, 622, 20);
		panel_aniadir.add(txtNombre);
	...
	public int confirmaEliminar() { 
		int opcion = JOptionPane.showConfirmDialog( this, "¿Desea eliminar el pedido de la base de datos?", "Eliminar", JOptionPane.YES_NO_OPTION,
			 JOptionPane.WARNING_MESSAGE); 
		return opcion; 
	}

	public int confirmaModificar() {
		int opcion2 = JOptionPane.showConfirmDialog( this, "¿Desea modificar el pedido en la base de datos?", "Modificar", JOptionPane.YES_NO_OPTION,
				 JOptionPane.WARNING_MESSAGE); 
		return opcion2;
	}
	
	public int salir() { 
		int opcion3 = JOptionPane.showConfirmDialog( this, "¿Desea volver al menú principal?", "Volver", JOptionPane.YES_NO_OPTION,
			 JOptionPane.WARNING_MESSAGE); 
		return opcion3; 
	}
	...
	public Pedido generarPedido() {
		Pedido pedido = null;
		if (txtNombre.getText().equals("") || txtFecha.getText().equals("") || txtAreaDescrip.getText().equals("") ||
			...
			JOptionPane.showMessageDialog(this, "El importe debe ser un número", "Error",
					JOptionPane.ERROR_MESSAGE);
		} else {
