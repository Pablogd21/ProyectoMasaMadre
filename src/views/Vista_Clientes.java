...
public class Vista_Clientes extends JPanel {
	...
	public Cliente generarClienteMod() {
		Cliente cliente = null;
			if (txtFieldNombre.getText().equals("") || txtFieldApellido.getText().equals("") || txtFieldEmail.getText().equals("") ||
				...
				cliente = new Cliente( Integer.parseInt(txtId.getText()),txtFieldNombre.getText(), txtFieldApellido.getText(), txtFieldEmail.getText(),
						txtFieldTelefono.getText(), txtFieldNacimiento.getText(), txtFieldDireccion.getText());
			}
		return cliente;
	}
	...
	public int confirmaEliminar() { 
		int opcion = JOptionPane.showConfirmDialog( this, "¿Desea eliminar el usuario de la base de datos?", "Eliminar", JOptionPane.YES_NO_OPTION,
			 JOptionPane.WARNING_MESSAGE); 
		return opcion; 
	}

	public int confirmaModificar() {
		int opcion2 = JOptionPane.showConfirmDialog( this, "¿Desea modificar el usuario en la base de datos?", "Modificar", JOptionPane.YES_NO_OPTION,
				 JOptionPane.WARNING_MESSAGE); 
		return opcion2;
	}
